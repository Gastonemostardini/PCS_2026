...
int main() {
    ...
    if (t.test_all_edges_returns_marked_edges() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_all_edges_returns_marked_edges" << endl;
    if (t.test_inner_product_orthogonal_is_zero() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_inner_product_orthogonal_is_zero" << endl;
    if (t.test_inner_product_non_orthogonal_is_one() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_inner_product_non_orthogonal_is_one" << endl;
    if (t.test_inner_product_size_mismatch_throws() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_inner_product_size_mismatch_throws" << endl;
    if (t.test_xor_symmetric_difference() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_xor_symmetric_difference" << endl;
    if (t.test_xor_with_self_is_zero() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_xor_with_self_is_zero" << endl;
    if (t.test_xor_size_mismatch_throws() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_xor_size_mismatch_throws" << endl;
    if (t.test_output_format() != EXIT_SUCCESS) return EXIT_FAILURE;
