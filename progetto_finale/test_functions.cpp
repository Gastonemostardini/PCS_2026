...
int main() {
    ...
    if (t.test_inner_product_even_overlap_is_false() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_inner_product_even_overlap_is_false" << endl;
    if (t.test_inner_product_odd_overlap_is_true() != EXIT_SUCCESS) return EXIT_FAILURE;
    ...
    if (t.test_xor_basic() != EXIT_SUCCESS) return EXIT_FAILURE;
    cout << "test_xor_basic" << endl;
    if (t.test_xor_disjoint() != EXIT_SUCCESS) return EXIT_FAILURE;
